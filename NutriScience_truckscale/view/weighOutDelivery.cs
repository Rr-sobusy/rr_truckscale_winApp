...
{
    public partial class weighOutDelivery : Form
    {
        ...
        public weighOutDelivery()
        {
            InitializeComponent();
        }

        private void weighOutDelivery_Load(object sender, EventArgs e)
        {
            plate_no = plateNo;
            gross = grossWeight;
            tare = tareWeight;
        ...
        private async void bunifuButton21_Click(object sender, EventArgs e)
        {
            ...
            //Load the datas to the print form
